...
struct Liga{
            ...
            for(set<string>::iterator it2=it->second.begin();it2!=it->second.end();it2++){
                ...
                if(*it2==szemely){
                    ...
                    if(it->first!=csapatnev){
                        ...
                        cout<<"Ervenytelen ajanlat: volt mar ilyen ajanlat "<<endl;
                        return;
    ...
    void visszavon(string csapatnev,string szemely){
        
        map<string,set<string>>::iterator fit=csapatszemely.find(csapatnev);
        
        set<string>::iterator fit2=fit->second.find(szemely);
        
        csapatszemely.at(fit->first).erase(*fit2);
